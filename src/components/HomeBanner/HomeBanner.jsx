        ...
        <section className="pt-24 bg-black w-full min-h-[750px]">
            <div className="relative z-10 px-4 md:px-8 xl:px-16 flex flex-col xl:flex-row justify-between items-center gap-16 lg:gap-24">
                <div className="h-full w-full xl:w-1/2">
                    <div className="pt-7 xl:pt-0 text-white flex flex-col xl:flex-row items-center gap-2 md:gap-4 xl:gap-0 tracking-wider">
                        <h2 className="text-2xl md:text-4xl xl:text-[26px] desktop_sm:text-3xl font-bold mr-4">Hey, I am </h2>
                        <WordRotate
                            className="text-[23px] md:text-4xl xl:text-[26px] desktop_sm:text-3xl font-bold text-green-500 tracking-wider"
                            words={["MD. Ashraf-Ul-Aanam Swapnil", "A Full Stack Web Developer", "A React Developer", "A MERN Stack Developer"]}
                        />
                    </div>
                    <p className="mt-7 text-white md:text-xl xl:text-base text-center xl:text-justify font-medium leading-loose md:leading-loose xl:leading-loose tracking-wider">
            ...
            <div className="w-full relative -bottom-8 xl:bottom-10 flex justify-center text-center">
